...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.end = end.clone()
        self.startSave = self.start.clone()
        self.endSave = self.end.clone()
        self.timesCloned = 0
    ...
    def line_plus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        newSX = self.start.x + other_line.start.x
        newSY = self.start.y + other_line.start.y
        newEX = self.end.x + other_line.end.x
        newEY = self.end.y + other_line.end.y
        newStart = Point(newSX,newSY)
        newEnd = Point(newEX,newEY)
        newLine = Line(newStart,newEnd)
        return(newLine)
    ...
    def midpoint(self):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        newMid = self.start.halfway_to(self.end)
        return (newMid)
    ...
    def reset(self):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        self.start = self.startSave
        self.end = self.endSave
